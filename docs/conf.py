...
"""
    ...
    sphinx-quickstart on Thu Jun 16 11:23:56 2016.
...
latex_documents = [
    (master_doc, 'Orchard.tex', '{name} Documentation'.format(name = PROJECTNAME), 'Bastian Meyer',
     'manual'),
]
...
man_pages = [
    (master_doc, 'orchard', '{name} Documentation'.format(name = PROJECTNAME), [author], 1)
]
...
texinfo_documents = [
    (master_doc, PROJECTNAME, '{name} Documentation'.format(name = PROJECTNAME), author,
     PROJECTNAME, 'Raspberry Pi Web Monitor.', 'Miscellaneous'),
]
